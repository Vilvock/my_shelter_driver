...
class AddPixFormAdapter (private val context: Context, private val listTravelHistory: List<Travel>,
                         private val clickOnListener: RecyclerItemClickListener
)
    : RecyclerView.Adapter<AddPixFormAdapter.TravelHistoryViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TravelHistoryViewHolder {
        val listItem: View = LayoutInflater.from(parent.context)
            .inflate(
                R.layout.adapter_add_pix_form,
                parent,
                false
