...
import kotlinx.android.synthetic.main.fragment_add_pix_form.save_bt_addPix


class AddPixFormFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_add_pix_form, container, false)
    }
