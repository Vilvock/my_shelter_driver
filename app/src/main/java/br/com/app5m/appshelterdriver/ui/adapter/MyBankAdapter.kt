...
class MyBankAdapter (private val context: Context, private val listTravelHistory: List<Travel>,
                     private val clickOnListener: RecyclerItemClickListener
)
    : RecyclerView.Adapter<MyBankAdapter.TravelHistoryViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TravelHistoryViewHolder {
        val listItem: View = LayoutInflater.from(parent.context)
            .inflate(
                R.layout.adapter_my_bank,
                parent,
                false
